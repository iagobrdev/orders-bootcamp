...
import com.br.bootcamp.orders.service.PedidoServiceImpl;
...
public class PedidoController {
    ...
    public ResponseEntity<List<Pedido>> buscarPorStatus(
            @Parameter(description = "Status dos pedidos", required = true) @PathVariable StatusPedido status) {
    ...
    public ResponseEntity<List<Pedido>> buscarPorPeriodo(
            @Parameter(description = "Data de início do período", required = true) @RequestParam LocalDateTime dataInicio,
            @Parameter(description = "Data de fim do período", required = true) @RequestParam LocalDateTime dataFim) {
